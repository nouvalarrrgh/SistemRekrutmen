<?php $__env->startSection('title', 'Sistem Penerimaan Karyawan'); ?>
                        ...
                        <table class="table table-hover aligncenter" id="showtable"  style="width:100%">
                            <thead>
                                <?php if(Auth::user()): ?>
                                    ...
                                    <tr>
                                        <th colspan="6">
                                        <a href="<?php echo e(route('jadwal.create')); ?>" type="button" class="btn btn-info btn-sm float-right"><i class="fa-solid fa-plus"></i> Tambah</a>
                                        </th>
                                    </tr>
                                    <?php endif; ?>
                                <?php endif; ?>
...
<?php echo $__env->make('layouts.adminlte.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tugasakhir-master\resources\views/jadwal/show.blade.php ENDPATH**/ ?>