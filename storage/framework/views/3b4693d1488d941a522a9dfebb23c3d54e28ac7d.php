            ...
            <div class="col-lg-12">
                <div class="card aligncenter d-flex flex-wrap align-items-center justify-content-center">
                    <div class="card-img-top">
                        <img class="imgoprec" src="<?php echo e(url('assets/image/oprec.jpg')); ?>" alt="">
                    </div>
                    <div class="card-body">
...
<?php echo $__env->make('layouts.adminlte.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tugasakhir-master\resources\views/beranda.blade.php ENDPATH**/ ?>